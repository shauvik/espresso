...
public final class ViewMatchers {
    ...
    /**
     * Returns a matcher that matches {@link View}s that are currently displayed on the screen to
     * the user.
     * <p/>
    ...
    public static Matcher<View> isDisplayingAtLeast(final int areaPercentage) {
        ...
        return new TypeSafeMatcher<View>() {
            ...
            public boolean matchesSafely(View view) {
                ...
                int viewHeight = (view.getHeight() > screen.height()) ? screen.height() : view
                        .getHeight();
                int viewWidth = (view.getWidth() > screen.width()) ? screen.width() : view
                        .getWidth();
            ...
            private Rect getScreenWithoutStatusBarActionBar(View view) {
                ...
                return new Rect(0, 0, m.widthPixels, m.heightPixels - (statusBarHeight +
                        actionBarHeight));
            }
        };
    }
     ...
     *
     * @param siblingMatcher a <a href="http://hamcrest.org/JavaHamcrest/javadoc/1.3/org/hamcrest/Matcher.html">
    ...
    /**
     * Returns an <a href="http://hamcrest.org/JavaHamcrest/javadoc/1.3/org/hamcrest/Matcher.html">
     * <code>Matcher</code></a> that matches {@link View}s based on content description
     ...
     * property value.
     *
     * @param charSequenceMatcher a {@link CharSequence} <a href="http://hamcrest.org/JavaHamcrest/javadoc/1.3/org/hamcrest/Matcher.html">
    ...
    /**
     * Returns a matcher that matches {@link View}s based on resource ids. Note: Android resource
    ...
    /**
     * Returns a matcher that matches {@link TextView} based on its text property value. Note:
    ...
    private static Matcher<View> withCharSequence(final int resourceId,
                                                  final TextViewMethod method) {
        return new BoundedMatcher<View, TextView>(TextView.class) {
            ...
            /* view could be from a context unaware of the resource id. */
                ...
                if (null != expectedText && null != actualText) {
                    // FYI: actualText may not be string ... its just a char sequence convert to
                    // string.
    ...
    /**
     * Returns a matcher that matches {@link TextView} based on it's hint property value. Note:
    ...
    /**
     * Returns a matcher that matches {@link View}s based on the presence of a descendant in its
     * view hierarchy.
     *
        ...
        return new TypeSafeMatcher<View>() {
            ...
            public boolean matchesSafely(final View view) {
                ...
                Iterator<View> matchedViewIterator =
                        Iterables.filter(breadthFirstViewTraversal(view),
    ...
    /**
     * Returns a matcher that matches {@link View}s that have "effective" visibility set to the
    ...
    public static Matcher<View> supportsInputMethods() {
        return new TypeSafeMatcher<View>() {
            ...
            @Override
            public boolean matchesSafely(View view) {
                // At first glance, it would make sense to use view.onCheckIsTextEditor,
                // but the android
                // javadoc is wishy-washy about whether authors are required to implement this
                // method when
